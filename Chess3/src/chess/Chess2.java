...
public class Chess2 extends EditArray
{
	...
	//makes a copy of initialOccuMap, but you can edit occuMap wihtout editing initialOccuMap; pretty cool I know
	...
	public static final String[] INTITIALPIECELIST = {
			...
			"wp1","wp2","wp3","wp4","wp5","wp6","wp7","wp8",
			"wr1","wk1","wb1","w_q","w_k","wb2","wk2","wr2"};
	//makes a copy of initialPieceList, but you can edit pieceList wihtout editing initialPieceList; pretty cool I know
...
//		drawMap();
	...
	public static boolean checkCheck(String king)
	{
		String position = positionOfPiece(king);
		String[] allOptions = {};
		char enemy = 'b', ally = 'w';
		if(king.charAt(0) == 'b')
		{
	...
	{
		int[] intialPosNos = positionArrayOfPiece(king);
		int[] posPosNos = positionArrayOfPosition(position);
		String[][] bOccu = copyString(occuMap);
		occuMap[intialPosNos[0]][intialPosNos[1]] = "   ";
	...
	*/
	...
	public static String[] knight(int[] positionNumbers, String positionMoveTo, String piece, int from, char enemy)
	{
		...
		if(positionNumbers[0] < 6 && positionNumbers[1] != 7)
		{
			if(occuMap[positionNumbers[0] + 2][positionNumbers[1] + 1].charAt(0) != ally)
			{
				options[0] = POSMAP[positionNumbers[0] + 2][positionNumbers[1] + 1];
			}
		}
		if(positionNumbers[0] < 6 && positionNumbers[1] != 0)
		{
			if(occuMap[positionNumbers[0] + 2][positionNumbers[1] - 1].charAt(0) != ally)
			{
				options[1] = POSMAP[positionNumbers[0] + 2][positionNumbers[1] - 1];
			}
		}
		if(positionNumbers[0] > 1 && positionNumbers[1] != 7)
		{
			if(occuMap[positionNumbers[0] - 2][positionNumbers[1] + 1].charAt(0) != ally)
			{
				options[2] = POSMAP[positionNumbers[0] - 2][positionNumbers[1] + 1];
			}
		}
		if(positionNumbers[0] > 1 && positionNumbers[1] != 0)
		{
			if(occuMap[positionNumbers[0] - 2][positionNumbers[1] - 1].charAt(0) != ally)
			{
				options[3] = POSMAP[positionNumbers[0] - 2][positionNumbers[1] - 1];
			}
		}
		if(positionNumbers[0] != 7 && positionNumbers[1] < 6)
		{
			if(occuMap[positionNumbers[0] + 1][positionNumbers[1] + 2].charAt(0) != ally)
			{
				options[4] = POSMAP[positionNumbers[0] + 1][positionNumbers[1] + 2];
			}
		}
		if(positionNumbers[0] != 0 && positionNumbers[1] < 6)
		{
			if(occuMap[positionNumbers[0] - 1][positionNumbers[1] + 2].charAt(0) != ally)
			{
				options[5] = POSMAP[positionNumbers[0] - 1][positionNumbers[1] + 2];
			}
		}
		if(positionNumbers[0] != 7 && positionNumbers[1] > 1)
		{
			if(occuMap[positionNumbers[0] + 1][positionNumbers[1] - 2].charAt(0) != ally)
			{
				options[6] = POSMAP[positionNumbers[0] + 1][positionNumbers[1] - 2];
			}
		}
		if(positionNumbers[0] != 0 && positionNumbers[1] > 1)
		{
			if(occuMap[positionNumbers[0] - 1][positionNumbers[1] - 2].charAt(0) != ally)
			{
				options[7] = POSMAP[positionNumbers[0] - 1][positionNumbers[1] - 2];
			}
		}
		if(from == 1 || from == 2)
		{
	...
	public static String[] rook(int[] positionNumbers, String positionMoveTo, String piece, int from, char enemy)
	{
		...
		int listLoop = 0;
		if(positionNumbers[0] > 0)
		{
			for(int rowsF = positionNumbers[0] - 1; rowsF >= 0; rowsF--)
			{
				if(occuMap[rowsF][positionNumbers[1]].equals("   "))
				{
					options[listLoop++] = POSMAP[rowsF][positionNumbers[1]];
				}
				else if(occuMap[rowsF][positionNumbers[1]].charAt(0) == enemy)
				{
					options[listLoop++] = POSMAP[rowsF][positionNumbers[1]];
					break;
				}
		...
		if(positionNumbers[0] < 7)
		{
			for(int rowsB = positionNumbers[0] + 1; rowsB <= 7; rowsB++)
			{
				if(occuMap[rowsB][positionNumbers[1]].equals("   "))
				{
					options[listLoop++] = POSMAP[rowsB][positionNumbers[1]];
				}
				else if(occuMap[rowsB][positionNumbers[1]].charAt(0) == enemy)
				{
					options[listLoop++] = POSMAP[rowsB][positionNumbers[1]];
					break;
				}
		...
		if(positionNumbers[1] > 0)
		{
			for(int colsL = positionNumbers[1] - 1; colsL >= 0; colsL--)
			{
				if(occuMap[positionNumbers[0]][colsL].equals("   "))
				{
					options[listLoop++] = POSMAP[positionNumbers[0]][colsL];
				}
				else if(occuMap[positionNumbers[0]][colsL].charAt(0) == enemy)
				{
					options[listLoop++] = POSMAP[positionNumbers[0]][colsL];
					break;
				}
		...
		if(positionNumbers[1] < 7)
		{
			for(int colsR = positionNumbers[1] + 1; colsR <= 7; colsR++)
			{
				if(occuMap[positionNumbers[0]][colsR].equals("   "))
				{
					options[listLoop++] = POSMAP[positionNumbers[0]][colsR];
				}
				else if(occuMap[positionNumbers[0]][colsR].charAt(0) == enemy)
				{
					options[listLoop++] = POSMAP[positionNumbers[0]][colsR];
					break;
				}
	...
	{
		String[] options = new String[14];
		int listLoop = 0, cols = positionNumbers[1];
		if(positionNumbers[0] > 0)
		{
			for(int negNeg = positionNumbers[0] - 1; negNeg >= 0; negNeg--)
			{
				if(cols > 0)
				{
					if(occuMap[negNeg][cols - 1].equals("   "))
					{
						options[listLoop++] = POSMAP[negNeg][cols - 1];
						cols--;
					}
					else if(occuMap[negNeg][cols - 1].charAt(0) == enemy)
					{
						options[listLoop++] = POSMAP[negNeg][cols - 1];
						break;
					}
			...
			cols = positionNumbers[1];
			for(int negPos = positionNumbers[0] - 1; negPos >= 0; negPos--)
			{
				if(cols < 7)
				{
					if(occuMap[negPos][cols + 1].equals("   "))
					{
						options[listLoop++] = POSMAP[negPos][cols + 1];
						cols++;
					}
					else if(occuMap[negPos][cols + 1].charAt(0) == enemy)
					{
						options[listLoop++] = POSMAP[negPos][cols + 1];
						break;
					}
		...
		{
			cols = positionNumbers[1];
			for(int posNeg = positionNumbers[0] + 1; posNeg <= 7; posNeg++)
			{
				if(cols > 0)
				{
					if(occuMap[posNeg][cols - 1].equals("   "))
					{
						options[listLoop++] = POSMAP[posNeg][cols - 1];
						cols--;
					}
					else if(occuMap[posNeg][cols - 1].charAt(0) == enemy)
					{
						options[listLoop++] = POSMAP[posNeg][cols - 1];
						if(from != 1)
						break;
			...
			cols = positionNumbers[1];
			for(int posPos = positionNumbers[0] + 1; posPos <= 7; posPos++)
			{
				if(cols < 7)
				{
					if(occuMap[posPos][cols + 1].equals("   "))
					{
						options[listLoop++] = POSMAP[posPos][cols + 1];
						cols++;
					}
					else if(occuMap[posPos][cols + 1].charAt(0) == enemy)
					{
						options[listLoop++] = POSMAP[posPos][cols + 1];
						break;
					}
	...
	public static String[] king(int[] positionNumbers, String positionMoveTo, String piece, int from, char enemy)
	{
		...
		if(positionNumbers[0] != 0)
		{
			if((occuMap[positionNumbers[0] - 1][positionNumbers[1]].charAt(0) == enemy || occuMap[positionNumbers[0] - 1][positionNumbers[1]].equals("   "))
					&& (from != 2 && !checkCheck(piece, POSMAP[positionNumbers[0] - 1][positionNumbers[1]]))) 
			{
				options[0] = POSMAP[positionNumbers[0] - 1][positionNumbers[1]];
			}
			if(positionNumbers[1] != 0)
			{
				if((occuMap[positionNumbers[0] - 1][positionNumbers[1] - 1].charAt(0) == enemy || occuMap[positionNumbers[0] - 1][positionNumbers[1] - 1].equals("   "))
						&& (from != 2 && !checkCheck(piece, POSMAP[positionNumbers[0] - 1][positionNumbers[1] - 1])))
				{
					options[1] = POSMAP[positionNumbers[0] - 1][positionNumbers[1] - 1];
				}
			}
			if(positionNumbers[1] != 7)
			{
				if((occuMap[positionNumbers[0] - 1][positionNumbers[1] + 1].charAt(0) == enemy || occuMap[positionNumbers[0] - 1][positionNumbers[1] + 1].equals("   "))
						&& (from != 2 && !checkCheck(piece, POSMAP[positionNumbers[0] - 1][positionNumbers[1] + 1])))
				{
					options[2] = POSMAP[positionNumbers[0] - 1][positionNumbers[1] + 1];
				}
			}
		}
		if(positionNumbers[0] != 7)
		{
			if((occuMap[positionNumbers[0] + 1][positionNumbers[1]].charAt(0) == enemy || occuMap[positionNumbers[0] + 1][positionNumbers[1]].equals("   "))
					&& (from != 2 && !checkCheck(piece, POSMAP[positionNumbers[0] + 1][positionNumbers[1]])))
			{
				options[3] = POSMAP[positionNumbers[0] + 1][positionNumbers[1]];
			}
			if(positionNumbers[1] != 0)
			{
				if((occuMap[positionNumbers[0] + 1][positionNumbers[1] - 1].charAt(0) == enemy || occuMap[positionNumbers[0] + 1][positionNumbers[1] - 1].equals("   "))
						&& (from != 2 && !checkCheck(piece, POSMAP[positionNumbers[0] + 1][positionNumbers[1] - 1])))
				{
					options[4] = POSMAP[positionNumbers[0] + 1][positionNumbers[1] - 1];
				}
			}
			if(positionNumbers[1] != 7)
			{
				if((occuMap[positionNumbers[0] + 1][positionNumbers[1] + 1].charAt(0) == enemy || occuMap[positionNumbers[0] + 1][positionNumbers[1] + 1].equals("   "))
						&& (from != 2 && !checkCheck(piece, POSMAP[positionNumbers[0] + 1][positionNumbers[1] + 1])))
				{
					options[5] = POSMAP[positionNumbers[0] + 1][positionNumbers[1] + 1];
				}
			}
		}
		if(positionNumbers[1] != 0)
		{
			if((occuMap[positionNumbers[0]][positionNumbers[1] - 1].charAt(0) == enemy || occuMap[positionNumbers[0]][positionNumbers[1] - 1].equals("   "))
					&& (from != 2 && !checkCheck(piece, POSMAP[positionNumbers[0]][positionNumbers[1] - 1])))
			{
				options[6] = POSMAP[positionNumbers[0]][positionNumbers[1] - 1];
			}
		}
		if(positionNumbers[1] != 7)
		{
			if((occuMap[positionNumbers[0]][positionNumbers[1] + 1].charAt(0) == enemy || occuMap[positionNumbers[0]][positionNumbers[1] + 1].equals("   "))
					&& (from != 2 && !checkCheck(piece, POSMAP[positionNumbers[0]][positionNumbers[1] + 1])))
			{
				options[7] = POSMAP[positionNumbers[0]][positionNumbers[1] + 1];
			}
		}
		if(from == 1 || from == 2)
		{
		...
		if(moveTrue.charAt(0) == 't')
		{
			...
			if(moveTrue.charAt(2) == '8' || moveTrue.charAt(2) == '9')
			{
				...
				{
					occuMap[positionNumbers[0]][positionNumbers[1] - 1] = piece; 
					if(!checkCheck("w_k"))
					{
						occuMap[positionNumbers[0]][positionNumbers[1] - 1] = "   "; 
